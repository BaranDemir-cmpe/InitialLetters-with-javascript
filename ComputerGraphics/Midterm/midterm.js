...
window.onload = function init() {
	...
	// for B;
	letter1vertices = [vec2(-0.6, -0.4),
	vec2(-0.5, -0.4),
	vec2(-0.6, 0.4),
	vec2(-0.5, 0.4)];

	letter4vertices = [vec2(-0.5, -0.3),
	vec2(-0.5, -0.4),
	vec2(-0.1, -0.1),
	vec2(-0.1, -0.2)];

	letter6vertices = [vec2(-0.5, 0.0),
	vec2(-0.5, -0.1),
	vec2(-0.1, -0.1),
	vec2(-0.1, -0.2)];
	

	letter7vertices = [vec2(-0.5, 0.4),
	vec2(-0.5, 0.3),
	vec2(-0.1, 0.3),
	vec2(-0.1, 0.2)];

	letter8vertices = [vec2(-0.5, 0.1),
	vec2(-0.5, 0.0),
	vec2(-0.1, 0.3),
	vec2(-0.1, 0.2)];
